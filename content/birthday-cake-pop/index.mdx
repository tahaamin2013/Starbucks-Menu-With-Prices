...
<div className="tables-container">
  <div className="table-wrapper">
    ...
    | Coating [White Confectionery Coating (Sugar, Palm Kernel And Palm Oils, Whey Powder, Nonfat Milk Powder, Soy Lecithin, Natural Flavor, Vanilla Extract), Palm Oil (Soy), Annatto Extract (Color), Vegetable Juice (Color)], Topping [Sugar, Cornstarch, Confectioners’ Glaze, Carnauba Wax]. Contains bioengineered food ingredients.|
  </div>
  <div className="table-wrapper">
    | Nutrition               |                      |  
    |:------------------------|---------------------:|
