...
Love Starbucks Cappuccino? Try the Caffè Latte next. It's softer, smoother, and milkier than a Cappuccino. The Latte has the same ingredients as a Cappuccino—coffee, milk, and foam—but it uses more milk and less foam.
...
The Signature Espresso Roast is bold, smooth, and has a caramel flavour. The standard number of espresso shots depends on the size of the drink:nature Espresso Roast is bold, smooth, and has a caramel flavour. The standard number of espresso shots depends on the size of the drink:
