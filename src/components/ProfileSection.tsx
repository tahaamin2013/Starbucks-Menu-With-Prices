...
const ProfileSection = () => {
  return (
    <div className="">
      <div className="relative rounded-2xl border mt-16 mb-32 max-w-xs mx-auto mt-24">
        <div className="rounded-2xl overflow-hidden shadow-glow shadow-black/25 bg-white">
          ...
          <div className="px-6 mt-16">
            <h1 className="font-bold text-3xl  mb-1">Amin Ahsan</h1>
            <p className="text-sm  text-slate-800 font-bold">Content Writer</p>
